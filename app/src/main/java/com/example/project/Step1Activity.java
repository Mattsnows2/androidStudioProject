...
//    UserViewModel mUserViewModel;
    ...
    //    mUserViewModel = new ViewModelProvider(this).get(UserViewModel.class);
        ...
        User newUser = new User(userId,email, 0, null, 0d);
        String userId2 =  String.valueOf(userId);
        mDatabase.child("users").child(userId2).setValue(newUser);
        //mUserViewModel.insert(new User(userId, email, 4,null,0d));



       // mUserViewModel.insert(new User(userId, email, 0,null,0d));
